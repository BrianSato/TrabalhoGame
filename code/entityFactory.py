...
from code.const import WIN_WIDTH, FRAME_DIABLO_WALK, FRAME_GENIUS_FLY, FRAME_LITTLE_MONSTER_WALK, \
    ...
    FRAME_MEDUSA_DEATH, FRAME_DRAGON_DEATH, FRAME_LITTLE_MONSTER_DEATH, FRAME_DRAGON_ATTACK
    ...
    def get_entity(entity_name, x=100, y=300):
        match entity_name:
            ...
            case 'DIABLO':
                ...
                return player
            case 'GENIUS':
                player = Genius(x, y, FRAME_GENIUS_FLY, FRAME_GENIUS_HIT, FRAME_GENIUS_FIGHT, FRAME_GENIUS_DEATH)
                return player
            case 'LITTLE_MONSTER':
            ...
            case 'DRAGON':
                enemy = Dragon('DRAGON', (WIN_WIDTH - 10, (WIN_HEIGHT - 150)), FRAME_DRAGON_WALK, FRAME_DRAGON_HIT,
                               FRAME_DRAGON_DEATH,FRAME_DRAGON_ATTACK)
                return enemy
