...
from code.const import WIN_WIDTH, FRAME_DIABLO_WALK, FRAME_GENIUS_WALK, FRAME_LITTLE_MONSTER_WALK, \
    ...
    FRAME_MEDUSA_DEATH, FRAME_DRAGON_DEATH
...
class FRAME_lITTLE_MONSTER_DEATH:
    pass
    ...
    def get_entity(entity_name, x=100, y=300):
        match entity_name:
            ...
            case 'DIABLO':
                ...
                return player
            case 'GENIUS':
                player = Genius(x, y, FRAME_GENIUS_WALK,FRAME_GENIUS_DEATH,FRAME_GENIUS_HIT,FRAME_GENIUS_FIGHT)
                return player
            case 'LITTLE_MONSTER':
                enemy = Enemy('LITTLE_MONSTER',(WIN_WIDTH +10, (WIN_HEIGHT -45)),FRAME_LITTLE_MONSTER_WALK,FRAME_LITTLE_MONSTER_HIT,FRAME_lITTLE_MONSTER_DEATH)
                return enemy
            case 'MEDUSA':
                enemy = Enemy('MEDUSA', (WIN_WIDTH + 10, (WIN_HEIGHT - 150)), FRAME_MEDUSA_WALK,FRAME_MEDUSA_HIT,FRAME_MEDUSA_DEATH)
                return enemy
            case 'DRAGON':
                enemy = Dragon('DRAGON',(WIN_WIDTH - 10, (WIN_HEIGHT - 150)),FRAME_DRAGON_WALK,FRAME_DRAGON_HIT,FRAME_DRAGON_DEATH)
                return enemy
